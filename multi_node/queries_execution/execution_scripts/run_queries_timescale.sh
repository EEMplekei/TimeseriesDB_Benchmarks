...
mkdir -p /home/ubuntu/TimeseriesDB_Benchmarks/multi_node/performance/queries/timescaledb/${QUERY_TEST}
rm -f /home/ubuntu/TimeseriesDB_Benchmarks/multi_node/performance/queries/timescaledb/${QUERY_TEST}/timescale_${QUERY_TEST}_${DATASET_SIZE}.out
...
for FULL_DATA_FILE_NAME in ${BULK_DATA_DIR}/queries_timescaledb/${DATASET_SIZE}/*; do
    ...
    OUT_FULL_FILE_NAME=${OUT_FULL_FILE_NAME:-"/home/ubuntu/TimeseriesDB_Benchmarks/multi_node/performance/queries/timescaledb/${QUERY_TEST}/timescale_${QUERY_TEST}_${DATASET_SIZE}.out"};
