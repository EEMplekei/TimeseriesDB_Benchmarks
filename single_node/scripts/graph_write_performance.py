...
axes[0].set_title('Timescale vs Influx rows/sec insertion speed')
...
axes[1].set_ylabel('kMetrics / second')
axes[1].set_title('Timescale vs Influx metrics/sec insertion speed')
